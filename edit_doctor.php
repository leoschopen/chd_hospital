...
$edit_act_code = "edit_doctor-act.php?{$url}";
?>
<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">修改医生信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">修改医生信息</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">修改医生信息</h3>
							<form action="<?php echo $edit_act_code ?>" method="post">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label for="room-id">科室号</label>
										<input type="text" placeholder="<?php echo $array['keshi_ID'] ?>" class="form-control"  name="keshi-id" value="<?php echo $array['keshi_ID'] ?>">
									</div>
									<div class="form-group col-md-6">
