					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">All 病房管理</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">病房管理 List</h3>							
...
while($array=mysqli_fetch_assoc($result)){
	// $delete_url=urlencode("del_bingfang-act.php?ID={$array['ID']}");
	// $edit_url=urlencode("edit_bingfang.php?ID={$array['ID']}");
	// $return_url=urlencode($_SERVER['REQUEST_URI']);
	$url=encrypt_url("ID={$array['ID']}"."&time=".time(),$key_url_md_5);
	$decode ="del_bingfang-act.php?{$url}";
	$decode2="edit_bingfang.php?{$url}";
	// $decode = urldecode($delete_url);
	$i=$i+1;
print<<<a
		<tr>
			<td>
