 				...
 				<div class="row">
 					...
 					<div class="col-lg-8">
 						<div class="main-menu">
							 ...
							 if(isset($_COOKIE['name'])){
print<<<a
		<a class="dropdown-item " href="add_doctor.php">添加医生信息</a>
...
a;
							 ...
							 if(isset($_COOKIE['name'])){
print<<<a
<a class="dropdown-item" href="add_nurse.php">添加护士信息</a>
...
a;
							 ...
							 if(isset($_COOKIE['name'])){
print<<<a
<a class="dropdown-item" href="add_patient.php">添加病人信息</a>
...
a;
							 ...
							 if(isset($_COOKIE['name'])){
print<<<a
<a class="dropdown-item" href="add_surgey.php">添加手术信息</a>
...
a;
							 ...
							 if(isset($_COOKIE['name'])){
print<<<a
<a class="dropdown-item" href="add_keshi.php">增加科室信息</a>
...
a;
							 ...
							 if(isset($_COOKIE['name'])){
print<<<a
<a class="dropdown-item" href="add_medicine.php">增加药品信息</a>
...
a;
							 ...
							 if(isset($_COOKIE['name'])){
print<<<a
<a class="dropdown-item" href="add_bingfang.php">增加病房信息</a>
