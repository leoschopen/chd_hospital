...
<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">添加护士信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">添加护士信息</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">添加护士信息</h3>
							<form action="/chd_hospital/add_nurse-act.php" method="post">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label for="keshi-id">病房号</label>
										<input type="text" placeholder="病房号" class="form-control" name="room-id">
									</div>
									<div class="form-group col-md-6">
